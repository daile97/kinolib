...
export const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 left-0 z-50 h-12 px-5 md:px-12 lg:px-40 flex items-center justify-between bg-[rgba(100,100,100,0.4)] backdrop-blur-md backdrop-saturate-200">
